...
##### PnL Distribution
![Weighted Histogram of Company PnL for Accumulator Products](source/products/accu_pnl_hist.png)
...
##### Maximum Drawdown
![Cumulative PnL and Maximum Drawdown for Accumulator Products](source/products/accu_cum_pnl.png)
...
##### PnL Distribution
![Weighted Histogram of Company PnL for Digits Products](source/products/digits_pnl_hist.png)
...
![Cumulative PnL and Maximum Drawdown for Digits Products](source/products/digits_cum_pnl.png)
...
##### PnL Distribution
![Weighted Histogram of Company PnL for Touch Bets Products](source/products/touch_pnl_hist.png)

The histogram above displays the weighted distribution of company PnL for Touch Bets products. 

##### Maximum Drawdown

![Cumulative PnL and Maximum Drawdown for Touch Bets Products](source/products/touch_cum_pnl.png)
...
add the theoretical using binomal var 99%.
maybe can so like vanilala last time 


accumulator is very complicated 
e(x^2) = [(1+g)^n-1]^2 * (1-p)^n +(-1)^2[1-(1-p)^n] 





1 dollar how much can i earn. 


sopread sheet format prefeered 
maybe a app instead of spread sheet 
make the metrics suitable for rakshit and praksahs to view 